            ...
            <div class="p-6">
                ...
                <div class="flex flex-col gap-4">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            <label class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Tên danh
                                mục <span class="text-rose-500">*</span></label>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Đường dẫn
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            <label class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Icon
                                (Material Symbols) <span class="text-rose-500">*</span></label>
                            <input type="text" name="icon" required
                                class="w-full bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg px-3 py-2 text-sm text-slate-900 dark:text-white focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary"
                                placeholder="VD: cake, favorite, celebration">
                            <p class="text-[10px] text-slate-400 dark:text-slate-500 mt-1">Sử dụng tên icon <a
                                    href="https://fonts.google.com/icons" target="_blank"
                                    class="hover:underline text-primary">Google Material Symbols</a>.</p>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Thứ tự hiển
                                thị</label>
                    ...
                    {{-- 3. Mô tả (Full width) --}}
                    <div>
                        <label class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Mô tả danh
                            mục</label>
                    ...
                    <div x-data="{ openSeo: false }"
                        class="border border-slate-100 dark:border-border-dark/50 rounded-lg overflow-hidden">
                        <button type="button" @click="openSeo = !openSeo"
                            ...
                            <span class="material-symbols-outlined text-[18px] transition-transform"
                                :class="openSeo ? 'rotate-180' : ''">expand_more</span>
                        </button>
                        <div x-show="openSeo"
                            class="p-4 flex flex-col gap-4 border-t border-slate-100 dark:border-border-dark/50 bg-white dark:bg-surface-dark/20"
                            x-cloak>
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    <label
                                        class="block text-xs font-medium text-slate-500 dark:text-slate-400 mb-1">Meta
                                        Title</label>
                            ...
                            <div>
                                <label class="block text-xs font-medium text-slate-500 dark:text-slate-400 mb-1">Meta
                                    Description</label>
                    ...
                    <div
                        class="flex items-center justify-between border-t border-slate-100 dark:border-border-dark/50 pt-4 mt-2">
            ...
            <div class="p-6">
                ...
                <div class="flex flex-col gap-4">
                    ...
                    <div
                        ...
                        <label class="relative inline-flex items-center cursor-pointer">
                            <input type="hidden" name="is_active" value="0">
                            <input type="checkbox" name="is_active" value="1" :checked="editCategory.is_active"
                                class="sr-only peer">
                            <div
                                class="w-11 h-6 bg-slate-200 dark:bg-slate-700 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-slate-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-primary">
                            </div>
                ...
                <div class="flex items-center gap-3 mb-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-slate-500">
                            Bạn có chắc muốn xóa danh mục <span class="font-bold text-slate-900 dark:text-white"
                                x-text="deleteCategory.name"></span>?
                        </p>
                    </div>
                </div>
                <div
                    class="bg-rose-50 dark:bg-rose-900/10 border border-rose-200 dark:border-rose-800/30 rounded-lg p-3">
                    <p class="text-sm text-rose-700 dark:text-rose-400">
                        ...
                        Hành động này sẽ thực hiện **xóa mềm** danh mục. Bạn vẫn có thể khôi phục lại trong cơ sở dữ
                        liệu nếu cần thiết.
                    </p>
                </div>
            </div>
