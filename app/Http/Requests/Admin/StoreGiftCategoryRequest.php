...
/**
 * Validate dữ liệu khi tạo danh mục quà tặng mới từ admin.
 */
class StoreGiftCategoryRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'slug' => ['required', 'string', 'max:255', 'unique:gift_categories,slug', 'regex:/^[a-z0-9]+(?:-[a-z0-9]+)*$/'],
