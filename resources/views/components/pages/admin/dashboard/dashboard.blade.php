<x-admin-layout title="NDHGift - Admin - Dashboard">
    ...
    <div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <div
            class="xl:col-span-2 rounded-lg border border-slate-200 dark:border-border-dark bg-white dark:bg-surface-dark p-6">
            ...
            <div class="h-64 flex items-end gap-2 sm:gap-4 md:gap-6 justify-between px-2">
                ...
                <div class="hidden sm:flex flex-col justify-between h-full text-xs text-slate-500 pb-6 -mr-2">
                    <span>100k</span>
                    <span>75k</span>
                    <span>50k</span>
                    <span>25k</span>
            ...
            <div
                ...
                <div class="flex flex-col gap-6">
                    ...
                    <div class="grid grid-cols-2 gap-4 mt-2">
                        <div class="bg-background-dark p-3 rounded-lg border border-border-dark text-center">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 h-full">
            ...
            <div class="flex flex-col gap-3">
                ...
                <div
                    ...
                    <p class="text-slate-900 dark:text-white text-sm font-medium mb-3">Fix API rate limiting bug on
                        production
                    </p>
                    <div class="flex items-center justify-between">
                        <div class="flex -space-x-2">
