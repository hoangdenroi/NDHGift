...
class UpdateGiftTemplateRequest extends FormRequest
{
    /**
    ...
    {
        $templateId = $this->route('gift_template');

        return [
            'category_id' => 'required|exists:gift_categories,id',
            'code' => 'required|string|max:100|regex:/^[a-z0-9_-]+$/|unique:gift_templates,code,' . $templateId,
    ...
    {
        // Loại bỏ các thẻ HTML thô chống XSS tấn công
        $this->merge([
