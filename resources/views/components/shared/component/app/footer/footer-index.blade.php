<footer class="bg-app-surface border-t border-app-border w-full px-6 py-12">
    <div class="max-w-[1400px] mx-auto w-full grid grid-cols-1 md:grid-cols-3 gap-12">
        <!-- Column 1: Company Info -->
        <div class="flex flex-col gap-4">
            <div>
                <h3 class="text-xs sm:text-sm font-black uppercase tracking-wider text-app-text mb-4">NDHShop
                </h3>
            ...
            <div class="pt-6 border-t border-app-border">
                {{-- <a href="#" target="_blank" class="text-xs text-app-muted hover:text-primary transition-colors">Bộ
                    công
                    thương</a> --}}
                <p class="text-xs text-app-muted mb-2">Copyright © {{ date('Y') }} NDHShop. All rights reserved.</p>
                {{-- <p class="text-xs text-app-muted mb-2">Version: 1.0.0</p> --}}
                ...
                <ul class="flex flex-col gap-3 text-xs sm:text-sm text-app-muted">
                    <li class="flex items-center gap-3">
                        ...
                        <a href="tel:+84388937608" class="hover:text-primary transition-colors">
                            Hotline: <span class="font-bold text-app-text">+84 388937608</span>
                        </a>
                    </li>
                    <li class="flex items-center gap-3">
                        ...
                        <a href="mailto:support@ndhshop.com" class="hover:text-primary transition-colors">
                            Email: <span class="font-bold text-app-text">support&#64;ndhshop.com</span>
                        </a>
                    </li>
                </ul>
            </div>
