...
<header
    class="flex items-center justify-between px-3 py-2 sm:px-6 sm:py-4 border-b border-app-border bg-app-surface z-20">
    <div class="flex items-center gap-2 sm:gap-4">
        <img src="{{ asset('NDHGift.jpg') }}" alt="Logo" class="size-10">
    ...
    <div class="flex items-center gap-2 sm:gap-4">
        ...
        <div class="flex items-center gap-1 sm:gap-2">
            ...
            {{-- <x-shared.layouts.app.ui.header-language /> --}}
            {{-- <x-shared.layouts.app.ui.header-mode /> --}}
            {{-- <x-shared.layouts.app.ui.header-notifications /> --}}
            ...
            <div class="relative" x-data="{ openProfile: false }">
                ...
                <div x-show="openProfile" @click.away="openProfile = false" @keydown.escape.window="openProfile = false"
                    ...
                    <div class="px-4 py-3 border-b border-app-border relative z-10 bg-inherit rounded-t-xl">
                        <p class="text-sm font-bold text-app-text truncate">{{ auth()->user()->name }}</p>
