                    ...
                    <div
                        ...
                        <div class="relative z-10 flex flex-col md:flex-row gap-10 items-center">
                            <div class="flex-1 flex flex-col gap-6 text-left">
                                ...
                                <p
                                    class="text-slate-500 dark:text-slate-300 text-lg md:text-xl font-normal leading-relaxed max-w-xl">
                                    Access thousands of premium scripts, app templates, and game source codes vetted by
                                    experts.
                                </p>
                                <div class="flex flex-wrap gap-4 pt-2">
                                    ...
                                    <button
                                        class="flex h-12 items-center justify-center rounded-lg bg-white dark:bg-slate-700 border border-slate-200 dark:border-slate-600 px-8 text-base font-bold text-slate-900 dark:text-white hover:bg-slate-50 dark:hover:bg-slate-600 transition-all">
                                        Sell Your Code
                                    </button>
                                </div>
                            </div>
                            <!-- Hero Image/Graphic -->
                            <div
                                class="w-full md:w-1/2 lg:w-5/12 aspect-[4/3] rounded-xl overflow-hidden shadow-2xl relative">
                                <div class="absolute inset-0 bg-gradient-to-tr from-slate-900/10 to-transparent z-10">
                                </div>
                                <div class="w-full h-full bg-slate-200 dark:bg-slate-700 bg-cover bg-center"
                                    data-alt="Coding on a laptop screen with colorful syntax highlighting"
                    ...
                    <div class="flex flex-col gap-6">
                            ...
                            <div class="lg:col-span-2 group cursor-pointer">
                                <div
                                    ...
                                    <div class="w-full md:w-1/2 bg-slate-200 dark:bg-slate-700 aspect-video md:aspect-auto bg-cover bg-center group-hover:scale-105 transition-transform duration-500"
                                        data-alt="Modern dashboard analytics interface on a screen"
                                    ...
                                    <div
                                        class="flex flex-col p-6 justify-between md:w-1/2 relative bg-white dark:bg-slate-800 z-10">
                                        <div class="flex flex-col gap-3">
                                            <div class="flex items-center justify-between">
                                                ...
                                                <div class="flex items-center gap-1 text-amber-500">
                                                    ...
                                                    <span
                                                        class="text-slate-700 dark:text-slate-300 text-sm font-semibold">4.9</span>
                                                </div>
                                            </div>
                                            <h3
                                            ...
                                            <p class="text-slate-500 dark:text-slate-400 text-sm line-clamp-3">A
                                                full-featured mobile application template for iOS and Android built with
                                                Flutter. Includes backend, admin panel, and payment gateway integration.
                                            </p>
                                        </div>
                                        <div class="flex items-end justify-between mt-6">
                                            <div class="flex flex-col">
                                                ...
                                                <span
                                                    class="text-slate-900 dark:text-white text-2xl font-bold">$49.00</span>
                                            </div>
                                            <button
                            ...
                            <div class="group cursor-pointer">
                                <div
                                    ...
                                    <div class="flex flex-col p-5 grow">
                                        <div
                                            class="mb-1 text-slate-500 dark:text-slate-400 text-xs font-medium uppercase">
                                            Web Scripts</div>
                                        <h3
                                        ...
                                        <div
                                            ...
                                            <span
                                                class="text-slate-900 dark:text-white text-lg font-bold">$129.00</span>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 pt-6">
                            ...
                            <div class="flex flex-col gap-3 group cursor-pointer">
                                <div
                                    class="relative w-full aspect-[4/3] rounded-xl overflow-hidden bg-slate-200 dark:bg-slate-700">
                                    <div class="w-full h-full bg-cover bg-center hover:scale-105 transition-transform duration-500"
                                        data-alt="Abstract code lines on dark screen"
                                ...
                                <div>
                                    <div class="flex justify-between items-start">
                                        <div>
                                            ...
                                            <p class="text-slate-500 dark:text-slate-400 text-sm mt-1">Game Templates
                                            </p>
                                        </div>
                                        <div
                            ...
                            <div class="flex flex-col gap-3 group cursor-pointer">
                                <div
                                    class="relative w-full aspect-[4/3] rounded-xl overflow-hidden bg-slate-200 dark:bg-slate-700">
                                    <div class="w-full h-full bg-cover bg-center hover:scale-105 transition-transform duration-500"
                                        data-alt="Point of sale tablet system in a cafe"
                                    ...
                                    <div class="flex justify-between items-start">
                                        <div>
                                            <h3
                                                class="text-slate-900 dark:text-white text-base font-bold leading-tight group-hover:text-primary transition-colors">
                                                Cloud POS System</h3>
                                            <p class="text-slate-500 dark:text-slate-400 text-sm mt-1">Web Applications
                                            </p>
                                        </div>
                                        <div
                                            class="bg-slate-100 dark:bg-slate-800 px-2 py-1 rounded text-xs font-bold text-slate-600 dark:text-slate-300">
                            ...
                            <div class="flex flex-col gap-3 group cursor-pointer">
                                <div
                                    class="relative w-full aspect-[4/3] rounded-xl overflow-hidden bg-slate-200 dark:bg-slate-700">
                                    <div class="w-full h-full bg-cover bg-center hover:scale-105 transition-transform duration-500"
                                        data-alt="Crypto currency mobile app interface on a phone"
                            ...
                            <div class="flex flex-col gap-3 group cursor-pointer">
                                <div
                                    class="relative w-full aspect-[4/3] rounded-xl overflow-hidden bg-slate-200 dark:bg-slate-700">
                                    <div class="w-full h-full bg-cover bg-center hover:scale-105 transition-transform duration-500"
                                        data-alt="Matrix style digital rain code background"
